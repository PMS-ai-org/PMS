...
export const appRoutes: Routes = [
  ...
  //{ path: 'appointment/:patientId', component: AppointmentComponent, data: { roles: ['Admin', 'Staff', 'Doctor'] } },
  { path: 'appointment', component: AppointmentComponent, data: { mode: 'create', roles: ['Admin', 'Staff', 'Doctor']} },
  { path: 'appointment/:patientId', component: AppointmentComponent, data: { mode: 'view', roles: ['Admin', 'Staff', 'Doctor'] } },
