...
import { MedicalHistoryDetailComponent } from './feature/medical-history/components/detail/medical-history-detail.component';
...
export const appRoutes: Routes = [
  ...
  { path: 'medicalHistoryDetails', component: MedicalHistoryDetailComponent },
