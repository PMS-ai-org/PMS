...
namespace PMS.WebAPI.Models.Dtos
{
    ...
    public record RegisterDoctorDto(string Username, string Email, string FullName, string PhoneNumber, string Specialization, Guid RoleId, List<ClinicSiteDto> ClinicSites, Dictionary<Guid, PermissionDto[]> Access); // Access can be simplified
